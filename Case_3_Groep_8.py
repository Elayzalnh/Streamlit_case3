...
df11 = pd.read_csv('Autos_merk_jaar_prijs.csv')
...
def elektrische_autos_pagina():
    ...
    fig1 = px.pie(brandstof_verdeling, values=brandstof_verdeling.values, names=brandstof_verdeling.index,
    ...
    filtered_df3 = df12[df12['Merk'] == merk_keuze]
    ...
    fig3 = px.line(gemiddelde_catalogusprijs, x=gemiddelde_catalogusprijs.index, y=gemiddelde_catalogusprijs.values,
